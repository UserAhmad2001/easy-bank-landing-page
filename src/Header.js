...
export default function Header(){
    ...
    return(
        <header>
            <img onClick={click} src="/easy-bank-landing-page/assets/images/logo.svg" alt="company logo" />
            <img className="menu" tabIndex={0} src="/easy-bank-landing-page/assets/images/icons8-menu.svg" alt="menu icon" />
            <nav>
